import { a as attr_class, s as store_get, e as ensure_array_like, b as attr, u as unsubscribe_stores } from "./index2.js";
...
function Modal($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attr_class("modal-overlay", void 0, { "active": open })}><div${attr_class("modal", void 0, { "modal-wide": wide })}><div class="modal-header"><div class="modal-title-group"><h2>${escape_html(title)}</h2> `);
    if (titleBadge) {
      $$renderer2.push("<!--[-->");
    ...
    $$renderer2.push(`<!--]--></div> <button class="modal-close" aria-label="Close"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button></div> <div class="modal-body">`);
    children($$renderer2);
    $$renderer2.push(`<!----></div> `);
    if (footer) {
      $$renderer2.push("<!--[-->");
    ...
    if (modelsToShow.length === 0) {
      ...
      for (let $$index_1 = 0, $$length = each_array.length; $$index_1 < $$length; $$index_1++) {
        ...
        for (let $$index = 0, $$length2 = each_array_1.length; $$index < $$length2; $$index++) {
          ...
          $$renderer2.push(`<label class="model-checkbox"><input${attr("type", mode)}${attr("name", mode === "radio" ? "model-selection" : void 0)}${attr("checked", isSelected(model.provider, model.id), true)}/> <span class="model-name">${escape_html(model.name)}</span></label>`);
        }
        $$renderer2.push(`<!--]--></div></div>`);
      }
      $$renderer2.push(`<!--]-->`);
